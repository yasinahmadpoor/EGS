...
Point(6) = {20, 40, -6000, 10};
Point(7) = {-20, 40, -6000, 10};
Point(8) = {-20, 0, -6000, 10};
Point(9) = {20, 0, -6000, 10};
Point(10) = {0, 20, -6000, 0.1};
Line(5) = {6, 7};
Line(6) = {7, 8};
Line(7) = {8, 9};
Line(8) = {9, 6};
...
Transfinite Curve {5, 1} = 5 Using Progression 1;
Recombine Surface {4};
Transfinite Surface {5};
Transfinite Curve {12, 13} = 10 Using Progression 1;
Transfinite Curve {7, 3} = 5 Using Progression 1;
Recombine Surface {5};
